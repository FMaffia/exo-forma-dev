...
export const UPDATE_PROJECT_API = 'update'
export const UPDATE_STEP_API = 'update/step'
export const GET_PROJECT_BY_PATH_API = 'path/'
export const GET_PROJECT_API = 'find'
export const UPLOAD_IMAGE_API = 'uploadImage/'
export const IMAGE_API = PROJECT_API + 'image/'
export const GET_STEPS_BY_ID_API = `steps/`

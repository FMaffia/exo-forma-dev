...
import { MenuFilter, ricercaMenu } from '../../models/menuItems'
...
const HomeMenu = ({ filter, setFilter }) => {
    ...
    return (
        <>
            ...
            <Divider />
            <List>
                <ListItem selected={location.pathname === '/progetti'} disablePadding sx={{ my: 2 }}>
                    <ListItemButton
                        onClick={() =>
                            handleClick({
                                path: '/',
            ...
            <List>
                ...
                {ricercaMenu.map(menu => (
                    <ListItem selected={location.pathname === menu.path} key={menu.menuLabel} disablePadding>
